            ...
            <div class="row">
                    ...
                    <card type="default" header-classes="bg-transparent">
                        <div slot="header" class="row align-items-center">
                            <div class="col">
                                ...
                                <h5 class="h3 text-white mb-0">Tournament Performance</h5>
                            </div>
                            <div class="col">
                ...
                <div class="col-xl-4">
                    <card header-classes="bg-transparent">
                        <div slot="header" class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">Rank Up Progress</h6>
                                <h5 class="h3 mb-0">Bush Noob</h5> <!-- TODO: Rank --> 
                            </div>
                        </div>
