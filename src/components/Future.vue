<template>
      <div id="careers" class='large-margin container'>
            ...
            <div class="row medium-margin">
                ...
                <div class="col-md-4">
                    <div class="job-card">
                        <h3 class="colored">ALPHA TOURNAMENTS</h3>
                        <p>Bigger the scale bigger the prize. Beware this isn't for bots</p>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h2 class="modal-title colored" id="lead-programmer">ALPHA TOURNAMENTS</h2>
                ...
                <div class="col-md-4">
                    <div class="job-card">
                        ...
                        <p>Player rankings which will be based on points earned through competing and will unlock many benefits</p>
                ...
                <div class="col-md-4">
                    <div class="job-card">
                        ...
                        <p>Sponsored Cup for the best players from Pakistan to compete and get huge prizes and recognition</p>
